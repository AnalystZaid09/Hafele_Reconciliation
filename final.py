...
st.set_page_config(page_title="Hafele Invoice ⇄ Excel Reconciliation", layout="wide")
...
if run_button:
    ...
    # download button
    st.download_button(
        label="Download styled reconciliation Excel",
        data=out2,
        file_name=f"reconciliation_{getattr(uploaded_pdf,'name','invoice')}.xlsx",
